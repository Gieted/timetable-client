...
public class ScrapingTimetableRepository {
    ...
    private final @NotNull CurrentWeekScraper currentWeekScraper;
    ...
    public ScrapingTimetableRepository(@NotNull Fetcher fetcher,
                                       ...
                                       @NotNull CurrentWeekScraper currentWeekScraper) {
        ...
        this.currentWeekScraper = currentWeekScraper;
    }
    ...
    public int getCurrentWeek(@NotNull Group group) throws TimetableUpdateException {
        String timetableHtml = fetcher.fetchTimetableHtml(group.getId());
        
        return currentWeekScraper.scrape(timetableHtml);
    }
}
